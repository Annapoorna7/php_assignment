...
<tr>
<td>Item Code</td>
<td><input class="w3-input" type="text" name="item_code" value="<?php echo
$item_code; ?>" readonly></td>
</tr>
<tr><td>Quantity</td>
<td><input class="w3-input" type="text" name="qty" placeholder="Enter Quantity"
required></td>
</tr>
<br>
</table>
